...
namespace GameFramework.Sound
{
    ...
    /// 声音管理器。
    /// </summary>
    internal sealed partial class SoundModule : GameFrameworkModule, ISoundModule
    {
        ...
        public int PlaySound(string soundAssetName, string soundGroupName, int priority, PlaySoundParams playSoundParams, object userData)
        {
            ...
            m_ResourceModule.LoadAsset(soundAssetName, priority, m_LoadAssetCallbacks, PlaySoundInfo.Create(serialId, soundGroup, playSoundParams, userData));
            return serialId;
        }
