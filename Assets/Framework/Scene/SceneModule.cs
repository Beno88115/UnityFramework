...
namespace GameFramework.Scene
{
    ...
    /// 场景管理器。
    /// </summary>
    internal sealed class SceneModule : GameFrameworkModule, ISceneModule
    {
        ...
        public void LoadScene(string sceneAssetName, int priority, object userData)
        {
            ...
            m_ResourceModule.LoadScene(sceneAssetName, priority, m_LoadSceneCallbacks, userData);
        }
        ...
        public void UnloadScene(string sceneAssetName, object userData)
        {
            ...
            m_ResourceModule.UnloadScene(sceneAssetName, m_UnloadSceneCallbacks, userData);
        }
