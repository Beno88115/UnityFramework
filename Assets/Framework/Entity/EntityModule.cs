...
namespace GameFramework.Entity
{
    ...
    internal sealed partial class EntityModule : GameFrameworkModule, IEntityModule
    {
        ...
        public void SetObjectPoolModule(IObjectPoolModule objectPoolModule)
        {
            ...
            m_ObjectPoolModule = objectPoolModule;
        }
        ...
        public bool AddEntityGroup(string entityGroupName, float instanceAutoReleaseInterval, int instanceCapacity, float instanceExpireTime, int instancePriority, IEntityGroupHelper entityGroupHelper)
        {
            ...
            m_EntityGroups.Add(entityGroupName, new EntityGroup(entityGroupName, instanceAutoReleaseInterval, instanceCapacity, instanceExpireTime, instancePriority, entityGroupHelper, m_ObjectPoolModule));
        ...
        public void ShowEntity(int entityId, string entityAssetName, string entityGroupName, int priority, object userData)
        {
            ...
            if (entityInstanceObject == null)
            {
                ...
                m_ResourceModule.LoadAsset(entityAssetName, priority, m_LoadAssetCallbacks, ShowEntityInfo.Create(serialId, entityId, entityGroup, userData));
                return;
            }
