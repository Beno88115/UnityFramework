...
namespace GameFramework.Entity
{
    internal sealed partial class EntityModule : GameFrameworkModule, IEntityModule
    {
        ...
        private sealed class EntityGroup : IEntityGroup
        {
            ...
            public EntityGroup(string name, float instanceAutoReleaseInterval, int instanceCapacity, float instanceExpireTime, int instancePriority, IEntityGroupHelper entityGroupHelper, IObjectPoolModule objectPoolModule)
            {
                ...
                m_InstancePool = objectPoolModule.CreateSingleSpawnObjectPool<EntityInstanceObject>(Utility.Text.Format("Entity Instance Pool ({0})", name), instanceCapacity, instanceExpireTime, instancePriority);
