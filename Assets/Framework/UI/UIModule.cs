...
namespace GameFramework.UI
{
    ...
    internal sealed partial class UIModule : GameFrameworkModule, IUIModule
    {
        ...
        public void SetObjectPoolModule(IObjectPoolModule objectPoolModule)
        {
            ...
            m_InstancePool = m_ObjectPoolModule.CreateSingleSpawnObjectPool<UIWindowInstanceObject>("UI Instance Pool");
        }
        ...
        public int OpenUIWindow(string uiWindowAssetName, string uiGroupName, int priority, bool pauseCoveredUIWindow, object userData)
        {
            ...
            if (uiWindowInstanceObject == null)
            {
                ...
                m_ResourceModule.LoadAsset(uiWindowAssetName, priority, m_LoadAssetCallbacks, OpenUIWindowInfo.Create(serialId, uiGroup, pauseCoveredUIWindow, userData));
            }
            else
            {
