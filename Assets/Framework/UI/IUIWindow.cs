...
namespace GameFramework.UI
{
    ...
    public interface IUIWindow
    {
        ...
        void OnInit(int serialId, string uiWindowAssetName, IUIGroup uiGroup, bool pauseCoveredUIWindow, bool isNewInstance, object userData);
