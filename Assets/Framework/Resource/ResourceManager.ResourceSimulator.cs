...
namespace GameFramework.Resource
{
    internal sealed partial class ResourceManager : GameFrameworkModule, IResourceManager
    {
        ...
        private sealed partial class ResourceSimulator
        {
            ...
            public ResourceSimulator(ResourceManager resourceManager)
            {
            ...
            public void InitResources(string currentVariant)
            {
                ...
                string[] assetBundleNames = m_ResourceManager.m_ResourceSimulationHelper.GetAllResourceNames();
                if (assetBundleNames.Length != 0)
                {
                    m_ResourceManager.m_AssetInfos = new Dictionary<string, AssetInfo>();
