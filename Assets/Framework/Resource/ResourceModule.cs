...
namespace GameFramework.Resource
{
    ...
    internal sealed partial class ResourceModule : GameFrameworkModule, IResourceModule
    {
        ...
        private ResourceSimulator m_ResourceSimulator;
        ...
        private IResourceSimulationHelper m_ResourceSimulationHelper;
        ...
        public ResourceModule()
        {
            ...
            m_ResourceSimulationHelper = null;
            m_ReadOnlyPath = null;
        ...
        public void SetResourceMode(ResourceMode resourceMode)
        {
            ...
            if (m_ResourceMode == ResourceMode.Unspecified)
            {
                ...
                else if (m_ResourceMode == ResourceMode.Simulation)
                {
                    m_ResourceSimulator = new ResourceSimulator(this);
                }
            }
        ...
        public void SetObjectPoolModule(IObjectPoolModule objectPoolModule)
        {
            ...
            m_ResourceLoader.SetObjectPoolModule(objectPoolModule);
        }
        ...
        public void SetDownloadModule(IDownloadModule downloadModule)
        {
            ...
            if (m_VersionListProcessor != null)
            {
                m_VersionListProcessor.SetDownloadModule(downloadModule);
            }

            if (m_ResourceUpdater != null)
            {
                m_ResourceUpdater.SetDownloadModule(downloadModule);
            }
        }
        ...
        /// </summary>
        /// <param name="resourceHelper">资源辅助器。</param>
        public void SetResourceSimulationHelper(IResourceSimulationHelper resourceSimulationHelper)
        {
            if (resourceSimulationHelper == null)
            {
                throw new GameFrameworkException("Resource simulation helper is invalid.");
            }
            m_ResourceSimulationHelper = resourceSimulationHelper;
        }
        ...
        public void InitResources()
        {
            ...
            {
                throw new GameFrameworkException("You can not use InitResources without simulation resource mode.");
            }

            m_RefuseSetCurrentVariant = true;
            m_ResourceSimulator.InitResources(m_CurrentVariant);
        }
