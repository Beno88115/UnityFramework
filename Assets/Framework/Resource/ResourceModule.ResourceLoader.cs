...
namespace GameFramework.Resource
{
    internal sealed partial class ResourceModule : GameFrameworkModule, IResourceModule
    {
        ...
        private sealed partial class ResourceLoader
        {
            ...
            public ResourceLoader(ResourceModule resourceModule)
            {
            ...
            public void SetObjectPoolModule(IObjectPoolModule objectPoolModule)
            {
                ...
                m_ResourcePool = objectPoolModule.CreateMultiSpawnObjectPool<ResourceObject>("Resource Pool");
            }
            ...
            public bool HasAsset(string assetName)
            {
                ...
                return m_ResourceModule.GetAssetInfo(assetName).HasValue;
            }
            ...
            public void UnloadScene(string sceneAssetName, UnloadSceneCallbacks unloadSceneCallbacks, object userData)
            {
                ...
                m_ResourceModule.m_ResourceHelper.UnloadScene(sceneAssetName, unloadSceneCallbacks, userData);
            }
            ...
            private bool CheckAsset(string assetName, out ResourceInfo? resourceInfo, out string[] dependencyAssetNames)
            {
                ...
                AssetInfo? assetInfo = m_ResourceModule.GetAssetInfo(assetName);
                if (!assetInfo.HasValue)
                {
                    return false;
                }

                resourceInfo = m_ResourceModule.GetResourceInfo(assetInfo.Value.ResourceName);
