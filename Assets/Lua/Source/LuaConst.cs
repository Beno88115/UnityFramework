...
{
    public static string luaDir = Application.dataPath + "/Lua/Scripts/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/Lua/Plugins/ToLua/Lua";        //tolua lua文件目录
